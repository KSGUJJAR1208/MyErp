											...
											<div class="panel-body" id="userAdd_panel_body">
												<form class="form-horizontal">
													<div class="col-lg-6">
														<div class="form-group">
														    ...
														    <div class="col-sm-9">
														      ...
														      oninvalid="this.setCustomValidity('Plese Select Session Name Here')" 
														...
														<div class="form-group">
														    ...
														    <div class="col-sm-9">
														      <select  class="form-control"  required 
														      oninvalid="this.setCustomValidity('Plese Select Class Name Here')" 
														      oninput="setCustomValidity('')">
														...
														<div class="form-group">
														    ...
														    <div class="col-sm-9">
														      <input type="text" class="form-control" placeholder="Section Full name ..." required 
													...
													<div class="col-lg-6">
														...
														<div class="form-group">
														    <label for="inputPassword3" class="col-sm-3 control-label">Section Code</label>
														    <div class="col-sm-9">
														      <input type="text" class="form-control"  placeholder="Enter Section  Code ..." required
														...
														<div class="form-group">
														    ...
														    <div class="col-sm-9">
														      <input type="number" class="form-control"  placeholder="Enter Section Strength ..." required
														...
														<div class="form-group">
														    ...
														    <div class="col-sm-9">
														      <input type="text" class="form-control"  placeholder="Enter Section Description ..." 
